...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}:{}@{}/{}".format('postgres', 'azertyuuop', 'localhost:5432', self.database_name)
        setup_db(self.app, self.database_path)
        
        self.new_question = {
            "question": "How many projects in this course ?",
            "answer": "4",
            "difficulty": "1",
            "category": "5"
                }
    ...
    def test_get_by_category(self):
        ...
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data["success"], True)
        self.assertEqual(data["questions"], questions_formatted)
        self.assertTrue(data["total_questions"])
    ...
    def test_get_question_search_with_results(self):
        res = self.client().post("/questions/search", json={"searchTerm": "Tim Burton"})
        data = json.loads(res.data)
